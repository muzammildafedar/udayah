...
class AppTextStyles {
  ...
  static const TextStyle heading1Black = TextStyle(
    fontFamily: 'Poppins',
    fontWeight: FontWeight.bold,
    color: Colors.black,
    fontSize: 32,
  ...
  // Mobile-specific Headings (adjusted font sizes)
  static const TextStyle heading1Mobile = TextStyle(
    fontFamily: 'Poppins',
    fontWeight: FontWeight.bold,
    color: Colors.black,
    fontSize: 24, // Mobile size
  );
